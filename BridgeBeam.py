...
class Chamfer:
    ...
    def top_part(self, build_ele):
        brep = AllplanGeo.BRep3D.CreateCuboid(
            AllplanGeo.AxisPlacement3D(AllplanGeo.Point3D(0 - (build_ele.Width_up.value - build_ele.Length.value) / 2, 0, build_ele.Thickness.value + build_ele.CentralHeight.value),
        ...
        brep_plate = AllplanGeo.BRep3D.CreateCuboid(
            AllplanGeo.AxisPlacement3D(AllplanGeo.Point3D(build_ele.PlateSpace.value - (build_ele.Width_up.value - build_ele.Length.value) / 2, 0, build_ele.Thickness.value + build_ele.CentralHeight.value + build_ele.Thickness5.value),
                                       AllplanGeo.Vector3D(1, 0, 0),
                                       AllplanGeo.Vector3D(0, 0, 1)),
    ...
    def central_part(self, build_ele):
        ...
        cone = AllplanGeo.BRep3D.CreateCylinder(
            AllplanGeo.AxisPlacement3D(AllplanGeo.Point3D(build_ele.ChamferWidth.value, build_ele.Width.value / 8, build_ele.Thickness.value + build_ele.CentralHeight.value / 2),
                                       AllplanGeo.Vector3D(0, 0, 1),
                                       AllplanGeo.Vector3D(1, 0, 0)),
            build_ele.Radius.value , build_ele.CenterWidth.value)

        cone1 = AllplanGeo.BRep3D.CreateCylinder(
            AllplanGeo.AxisPlacement3D(AllplanGeo.Point3D(build_ele.ChamferWidth.value, build_ele.Width.value - build_ele.Width.value / 8, build_ele.Thickness.value + build_ele.CentralHeight.value / 2),
                                       AllplanGeo.Vector3D(0, 0, 1),
                                       AllplanGeo.Vector3D(1, 0, 0)),
            build_ele.Radius.value , build_ele.CenterWidth.value)
    ...
    def bottom_part(self, build_ele):
        ...
        chamfer_width = build_ele.ChamferWidth.value
        chamfer_width_bottom = build_ele.ChamferWidthBottom.value
   ...
   def create_handles(self, build_ele):
        ...
        origin3 = AllplanGeo.Point3D(
            0, build_ele.Width.value, (build_ele.Thickness.value - build_ele.ChamferWidth.value) / 2)
        origin4 = AllplanGeo.Point3D(
            0 - (build_ele.Width_up.value - build_ele.Length.value) / 2, build_ele.Width.value, build_ele.CentralHeight.value + build_ele.Thickness.value + build_ele.ChamferWidth_up.value)
        ...
        origin6 = AllplanGeo.Point3D(
            build_ele.Length.value / 2, build_ele.Width.value, build_ele.CentralHeight.value + build_ele.Thickness.value + build_ele.Thickness5.value)
